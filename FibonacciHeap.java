...
public class FibonacciHeap
{
    ...
    public void NulffyParent(HeapNode x)
    {
        HeapNode temp =  x;
    ...
    public HeapNode link(HeapNode x, HeapNode y){
        ...
        if(x.getRank()==0) {
            ...
            HeapNode xChild = x.getChild();
            HeapNode xLastChild = xChild.getPrev();
            x.setChild(y);
            y.setParent(x);
            y.setNext(xChild);
            xChild.setPrev(y);
            y.setPrev(xLastChild);
            xLastChild.setNext(y);
    ...
    public void cascadingCut(HeapNode x, HeapNode y){
        ...
        if(y.getParent()!=null){
            ...
            else cascadingCut(y,y.getParent());
        }
    }
    /**
